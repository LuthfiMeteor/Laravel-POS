<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="{{ url($setting->path_logo) }}" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">{{ $setting->nama_perusahaan }}</span>
            <small>Login @if (Auth::User()->level == '1')
                    {{ 'Admin' }}
                @else
                    {{ 'Kasir' }}
                @endif
                    ...
                    <a class="nav-link {{ Request::is('user') ? 'active' : '' }}"
                        ...
                        <div
                            ...
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('user') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
